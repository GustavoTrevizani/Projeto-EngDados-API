...
tmp_parquet_path = "/tmp/transient/tb_fat_sales_orders_1"
...
expectativa_nulos_outra = df_ge.expect_column_values_to_not_be_null(column='PARTNERID')
...
delta = "/tmp/bronze/tb_fat_sales_orders"
df.write.partitionBy("dt_ingestion").format("delta").mode("overwrite").save(delta)

# COMMAND ----------

# MAGIC %fs ls dbfs:/tmp/bronze/tb_fat_sales_orders
